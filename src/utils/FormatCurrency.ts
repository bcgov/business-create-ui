...
export function FormatCurrency (value: number): string {
  ...
  if (value < 1e-12) {
    ...
    return value.toLocaleString('en-US',
      { notation: 'scientific', minimumFractionDigits: 1, maximumFractionDigits: 100 }
    )
  }
  ...
  if (value < 1e7) {
    ...
    // eg, 100.00
    // eg, 9,999,999.99
    return value.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 100 })
  }
  ...
  if (value < 1e10) {
    // eg, 10,000,000
    // eg, 10,000,000.01
    return value.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 100 })
  }

  // show very large numbers in scientific notation
  // eg, 50,000,000,000 => "5.0E10"
  // eg, 1,234,000,000,000 => "1.234E12"
  return value.toLocaleString('en-US', { notation: 'scientific', minimumFractionDigits: 1, maximumFractionDigits: 100 })
}
