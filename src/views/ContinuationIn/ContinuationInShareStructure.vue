<template>
  <div id="continuation-in-share-structure">
    <section class="mt-10">
      <header>
        <h2>1. Create Your Authorized Share Structure</h2>
      </header>

      <p id="continuation-in-share-structure">
...
export default class ContinuationInShareStructure extends Mixins(CommonMixin) {
  ...
  private async scrollToInvalidComponent (): Promise<void> {
    if (this.getShowErrors && this.$route.name === RouteNames.CONTINUATION_IN_SHARE_STRUCTURE) {
      ...
      await this.validateAndScroll(
        ...
        ['continuation-in-share-structure']
      )
    }
  }
}
