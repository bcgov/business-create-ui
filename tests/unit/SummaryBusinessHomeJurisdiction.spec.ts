...
describe('Summary Business Home Jurisdiction component', () => {
  it('renders the component correctly - first summary', async () => {
    ...
    expect(wrapper.find('.businessHomeStepErrorMessage').exists()).toBe(true)
    expect(wrapper.find('.businessHomeStepErrorMessage span').text()).toBe('This step is unfinished.')
    expect(wrapper.find('.businessHomeStepErrorMessage a span').text()).toBe('Return to this step to finish it')
